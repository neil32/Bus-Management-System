...
<div class="maindiv">
 ...
 <table border="2" cellspacing="3" cellpadding="3" align="center" height="400" width="400" bgcolor="#ececec">
 <tr>
 <th>Bus Number</th><th>Driver Name</th><th>Route ID</th><th>Checkpoint</th><th>Shift</th>
 </tr>
 ...
 <%
   ...
   for(Daily d2 : mylist) {
	   ...
	   <th><% out.println(d2.getRoute_id()); %></th>
